...
index e53bf9fcc4f611804a482f65ce51b1a3523e4eba..2d6ee9b80cae706b3c3f1effcd34b6733ac771f7 100644
--- a/storage.js
+++ b/storage.js
@@ -1,57 +1,153 @@
...
@@ -61,156 +157,191 @@ async function recomputeTrendWeightsForPerson(tx, personId) {
...
@@ -284,80 +415,300 @@ export async function getLoggedDatesByPerson(personId) {
...
@@ -398,124 +749,151 @@ export async function getRecents(personId, limit = 20) {
     const out = [];
